...
<path
    ...
    <path
      ...
      fill="#454545"
    ></path>
    <path d="M14.5 13.1667H13.1667V14.5H14.5V13.1667Z" fill="#454545"></path>
    <path d="M10.5 9.16667H9.16667V10.5H10.5V9.16667Z" fill="#454545"></path>
    <path d="M11.8333 10.5H10.5V11.8333H11.8333V10.5Z" fill="#454545"></path>
    <path d="M10.5 11.8333H9.16667V13.1667H10.5V11.8333Z" fill="#454545"></path>
    <path d="M11.8333 13.1667H10.5V14.5H11.8333V13.1667Z" fill="#454545"></path>
    <path d="M13.1667 11.8333H11.8333V13.1667H13.1667V11.8333Z" fill="#454545"></path>
    <path d="M13.1667 9.16667H11.8333V10.5H13.1667V9.16667Z" fill="#454545"></path>
      ...
      <div className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-2">
        {/*<div className="font-bold flex flex-col h-full justify-center items-center ">*/}
          ...
          <div className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0">
            <div
  class="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-1 p-1"
>
  <p class="flex-grow-0 flex-shrink-0 text-base font-medium text-left text-[#888]">Balance</p>
</div>
  ...
  <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-1 p-1">
    <p class="flex-grow-0 flex-shrink-0 text-[32px] font-black text-left text-[#3d3d3d]">$</p>
    <p class="flex-grow-0 flex-shrink-0 text-[40px] font-black text-left text-[#3d3d3d]">6.552</p>
  </div>
</div>
        {/*</div>*/}
      </div>
